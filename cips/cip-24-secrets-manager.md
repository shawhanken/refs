...
> **⚠️ [2026-09-21] STALE SNAPSHOT — 过时快照.** This `refs/cips/` copy is superseded; the authoritative, code-aligned spec lives at **`cowboy/docs/cips/cip-24-secrets-manager.md`**. This copy was last updated **2026-05-26**, the authoritative doc **2026-08-13**, and the two have diverged by **555 diff lines** (1451L here vs 1748L there). The text below is retained as a historical record — **do not build against it**. For current system-actor addresses see [`refs/wiki/entities/system-actors.md`](../wiki/entities/system-actors.md).
