...
| Mailbox Send (per message, payload extra) | 500 |
| Set Timer (+ cells) | 1,000 |
| Cancel Timer | 500 |
...
* **Core Principle:** The protocol sets an ideal "target usage" (T_c and T_b) for Cycles and Cells at 50% of block capacity. **Cycle target: 10,000,000 cycles/block. Cell target: 500,000 cells/block.**
